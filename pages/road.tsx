            ...
            <Box borderWidth="1px" borderRadius="lg" mb={5}>
                <Box p={6}>
                    ...
                    <Text fontSize="lg">
                        ...
                        <Icon as={MdCheckCircle} color="green.500" /> Token Issuance : Launching the HASH token with limited supply.<br />
                        <Icon as={MdCheckCircle} color="green.500" /> Founder's Comment: <br />
