        ...
        <Container maxW="95%" mt={8} px={4} bg="gray.100">
            ...
            <Box borderWidth="1px" borderRadius="lg" mb={5}>
                <Box p={6}>
                    ...
                    <Text mb={2}><b>DexTools</b> ({""}<a href="https://www.dextools.io/app/en/base/pair-explorer/0x72cd910631a66149d3ce95d8c382de1e1d758096?t=1715768426824" target="_blank" rel="noopener noreferrer" style={{ color: 'blue' }}>Hash Coin</a>)</Text>
                </Box>
            </Box>
