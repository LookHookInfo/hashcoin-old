import { Container, Heading, Text, Divider, Box, Icon, Link } from "@chakra-ui/react";
            ...
            <Box borderWidth="1px" borderRadius="lg" mb={5}>
                <Box p={6}>
                    ...
                    <Text fontSize="lg">
                        ...
                        <Icon as={MdCheckCircle} color="green.500" /> Token Issuance (<Link href="https://basescan.org/address/0xa9b631abcc4fd0bc766d7c0c8fcbf866e2bb0445" target="_blank" rel="noopener noreferrer" color="blue.500">Contract</Link>): Launching the HASH token with limited supply.<br />
                        <Icon as={MdCheckCircle} color="green.500" /> Founder&apos;s Comment: (<Link href="https://x.com/PrimeBlocks/status/1790817564932677791" target="_blank" rel="noopener noreferrer" color="blue.500">Link</Link>)<br />
