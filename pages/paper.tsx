    ...
    return (
        <Container maxW="95%" mt={8} px={4} bg="gray.100">
            <Box borderWidth="1px" borderRadius="lg" mb={5} p={6}>
                ...
                <Heading as="h3" mt={8} mb={4}>Contract Information</Heading>
                ...
                <Heading as="h3" mt={8} mb={4}>Token Distribution</Heading>
                <Text fontSize="lg" textAlign="justify">
                ...
                <Heading as="h3" mt={8} mb={4}>Key Features</Heading>
                <Text fontSize="lg" textAlign="justify">
                ...
                <Heading as="h3" mt={8} mb={4}>Profit Distribution from NFT Sales</Heading>
                <Text fontSize="lg" textAlign="justify">
                ...
                <Heading as="h3" mt={8} mb={4}>Future Development</Heading>
                <Text fontSize="lg" textAlign="justify">
